...
public class ArticleController extends ApiController {
    ...
    public Article postArticle(
            ...
            @ApiParam("date added (in iso format, e.g. YYYY-mm-dd; see https://en.wikipedia.org/wiki/ISO_8601)") @RequestParam("dateAdded") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dateAdded)
